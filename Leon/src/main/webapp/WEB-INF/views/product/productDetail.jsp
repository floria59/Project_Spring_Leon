	  	...
	  	<div class="row mb-3">
		    ...
		    <div class="col-md-5">
		      <div class="card-body" style="text-align: left;">
		        ...
		        <p>Price : <b><fmt:formatNumber type="currency" pattern="#,###" value="${productVO.pdt_price }" /></b>원 </p>
		        <p>수량 : <input type="text" name="odr_amount" value="1"> 개 </p>
		        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
		      </div>
		      <div class="card-body" style="text-align: center;">
		         <button type="button" name="btnDirectOrder"  class="btn btn-pill text-black btn-block btn-outline-success">바로구매</button>
		         <button type="button" name="btnCart" class="btn btn-pill text-black btn-block btn-outline-success">장바구니</button>
		      </div>
		    </div>
		</div>
	   			...
	   			<div id="product_qna">
	   				...
	   				<div class="form-group row" >
	   					<div class="col-md-12">
	   						...
	   						<button type="button" id="btn_review_write" class="btn btn-link text-dark"  style="text-decoration: none">등록하기</button>
