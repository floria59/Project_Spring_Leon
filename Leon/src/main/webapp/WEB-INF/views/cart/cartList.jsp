  		...
  		<div class="box">
			...
			<div class="box-body no-padding">
				...
				<tr style="text-align: center" >
					...
					<td><span class="pdt_price"><fmt:formatNumber type="currency" pattern="#,###" value="${cartListVO.pdt_price }" /></span>원</td>
					<td>
						<input type="number" name="cart_amount" value="${cartListVO.cart_amount }" style="width:50px;">개<br>
						<button type="button" name="btnQtyChange" class="btn " style="text-decoration-line: none" >변경</button>
					</td>
					<td>포인트</td>
					<td>기본배송</td>
					<td>무료</td>
					<td><span class="sales_price"><fmt:formatNumber type="currency" pattern="#,###" value="${cartListVO.sales_price }" />원
					</span></td>
					<td>
				...
				<tfoot>
					...
					<c:if test="${!empty  cartList}">
						<td colspan="10" style="text-align: right">총 금액 : <b style="font-size: x-large"><span id="sum_price"><fmt:formatNumber type="currency" pattern="#,###" value="${sum_price }" /></span>원</b></td>
					</c:if>
					</tr>
				</tfoot>
				</table>
				...
				<div class="box-footer">
					<div class="row">
						<div class="col-md-12">
							<button type="button" name="btnSelectDel" class="btn btn-light" style="text-decoration-line: none">선택삭제</button>
							<button type="button" name="btnCartEmpty" class="btn btn-light" style="text-decoration-line: none">장바구니비우기</button>
							<button type="button" name="btnOrder" class="btn btn-success" style="float: right">주문하기</button><br>
						</div>
					</div>
				</div>
				</c:if>
