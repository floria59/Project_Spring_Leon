  	...
  	<div class="col-md-12">
  		<div class="box">
			<div class="box-header">
				<h2 class="box-title" style=text-align:center> ORDER / PAYMENT </h2>
			</div>
			<br>
			...
			<div class="box-body no-padding">
				...
				<tr style=text-align:center>
					...
					<td><span class="pdt_price"><fmt:formatNumber type="currency" pattern="#,###" value="${orderListVO.pdt_price }" /></span>원</td>
					<td>
						<input type="text" name="cart_amount" id="d_odr_amount" value="${orderListVO.cart_amount }" style="width:40px;">개<br>
					...
					<input type="hidden" name="sales_price" id="d_odr_price" value="${orderListVO.sales_price }">원
					</td>
				...
				<tfoot>
					<tr> 
						<td colspan="10" style="font-size: small" > ※ 상품의 옵션 및 수량 변경은 상품상세 또는 장바구니에서 가능합니다. </td>
					</tr>
					<tr>
					...
					<c:if test="${!empty  orderList}">
						<td colspan="10" style="text-align: right">총 결제금액  <b style="font-size: x-large"><span id="sum_price"><fmt:formatNumber type="currency" pattern="#,###" value="${sum_price }" /></span>원</b></td>
					</c:if>
					</tr>
				</tfoot>
				</table>
				...
				<div>
					<form id="orderForm" action="" method="post">
						  ...
						  <h5>배송 정보</h5> 
						  <input type="checkbox" id="same"> <label for="same" > 주문자 정보와 같음</label>
						  <hr>
						  <div class="form-group row">
						    <label for="mem_name" class="col-sm-2 col-form-label">이름</label>
						    <div class="col-sm-10">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-sm-3">
						      <input type="button" class="form-control btn btn-success" onclick="sample2_execDaumPostcode()" value="우편번호 찾기">
						    </div>
						  </div>
						  <div class="form-group row">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-sm-10">
						      <textarea name="odr_message" class="form-control" rows="3"></textarea>
			...
			<div class="mb-4">
				...
				<div class="form-group row">
	     		...
	     		<div class="form-group row">
					<div class="col-sm-12 text-center">
		     			<button type="button" id="btnOrder" class="btn btn-pill btn-block btn-success">
		     				<c:if test="${!empty  orderList}">
								<b style="font-size: x-large"><span id="sum_price" ><fmt:formatNumber type="currency" pattern="#,###" value="${sum_price }" /></span>원 </b>
								<br>결제하기
							</c:if>
						</button>
					</div>
				...
				<div class="form-group row">
	     			<div class="col-sm-12 text-center">
	     				<button type="button" id="btnCancel" class="btn btn-pill text-black btn-block btn-outline-success">주문취소</button>
	     			</div>
	     		</div>
