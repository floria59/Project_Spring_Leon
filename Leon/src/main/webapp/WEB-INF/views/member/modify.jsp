  ...
  <div class="mb-3 text-center">
	  <form id="modifyForm" action="modify" method="post">
		  <div class="form-group row">
		    <label for="mem_id" class="col-sm-2 col-form-label" style= text-align:left>아이디</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group row">
		    <label for="sample2_postcode" class="col-sm-2 col-form-label" style= text-align:left>우편번호</label>
		    <div class="col-sm-7">
		  ...
		  <div class="form-group row">
		    <label for="sample2_address" class="col-sm-2 col-form-label" style= text-align:left>주소</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="sample2_address" name="mem_addr" value="${memberVO.mem_addr}">
		    </div>
		  </div>
		  <div class="form-group row">
		    <label for="sample2_detailAddress" class="col-sm-2 col-form-label" style= text-align:left>상세주소</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group row">
			  <div class="col-sm-12 text-center">
			  	<button type="button" class="btn btn-pill text-black btn-block btn-outline-success" id="btnModify">수정하기</button>
			  </div>			
		  </div>
	 </form>
  </div>
