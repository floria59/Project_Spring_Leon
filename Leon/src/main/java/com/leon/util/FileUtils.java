...
public class FileUtils {
	...
	//파일업로드 작업.   C:\\solproject\\upload\\goods\\2022\\11\\22
	public static String uploadFile(String uploadFolder, String uploadDateFolderPath, MultipartFile uploadFile) {
		...
		try {
			...
			if(checkImageType(saveFile)) {
				...
				// 파일생성위치:  C:\\solproject\\upload\\goods\\2022\\12\\25\\abc.gif
	...
	//날짜폴더 생성하기위한 날짜형태의 문자열(운영체제 경로의 구분자) / 날짜폴더 생성 및 리턴
	public static String getFolder() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		
		Date date = new Date();
		
		String str = sdf.format(date); // "2022-12-25"
		
		//1)리눅스 또는 맥은 구분자 / : "2022-12-25" -> "2022/12/25"
		//2)윈도우즈 \ : "2022-12-25" -> "2022\12\25"
	...
	//파일삭제
	// uploadPath : "C:\\solproject\\upload\\goods\\"
