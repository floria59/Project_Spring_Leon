...
import com.leon.kakaopay.ApproveResponse;
import com.leon.kakaopay.ReadyResponse;

import lombok.extern.log4j.Log4j;


//카카오페이 API서버에 실제요청하는 작업
//KakaoPayService 인터페이스 사용안함
@Log4j
@Service
public class KakaoPayServiceImpl {
	...
	/*
	 ...
	 2)RestTemplate를 이용한 통신(스프링에서 권장) : https://minkwon4.tistory.com/178 참고하기
	 */
	...
	public ReadyResponse payReady(Long odr_code, String itemName, int quantity, String mem_id, int totalAmount) {
		...
		// postForObject메서드
		// 첫번째 파라미터 : 카카오페이 요청주소, 두번째 파라미터 : 요청시 사용할 파라미터와 헤더정보구성, 세번째 파라미터 : 리턴받는 클래스정보
		// 리턴값 : 
	...
	private HttpHeaders getHeaders() {
		...
		headers.set("Authorization", "KakaoAK 9db6d546a00e1f0e7876a6ac8261a38b");
